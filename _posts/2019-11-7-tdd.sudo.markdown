...
Test driven development documents your development process. The initial tests are for the most fundamental code, like a constructor. Here are some of my beggining tests from [Kata ]
